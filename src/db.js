...
if (usePostgres) {
  ...
  try {
    ...
    db.exec(`UPDATE users SET is_developer = 1, can_technical = 0, can_hr = 0 WHERE lower(email) IN ('gauravkhandelwal205@gmail.com', 'heramb15012006@gmail.com')`);
  ...
  if (!DatabaseSync) {
    ...
    try {
      ...
      try {
        sqliteDb.exec("UPDATE users SET is_developer = 1, can_technical = 0, can_hr = 0 WHERE lower(email) IN ('gauravkhandelwal205@gmail.com', 'heramb15012006@gmail.com');");
